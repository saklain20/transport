...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand navbar-dark bg-dark static-top" style="background-image: linear-gradient(pink,#2144);">
      ...
      <a class="navbar-brand mr-1" href="index.php"></a>Transportation Management System
        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb"
            <li class="breadcrumb-item" style="background-image: linear-gradient();">
              <a href="Transportation system.php"> <h2> Transportation Management System</h2> </a>
            </li>
          ...
          <!-- Page Content -->
          <div class="bus_logo">
            <a class="image full"><img src="image/t-1.jpg" style="width:800px;" style="background-attachment: fixed;" style="background-size: contain;"  > </a>
